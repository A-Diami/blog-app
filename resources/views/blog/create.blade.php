...
@section('content')
    ...
    <div class="w-4/5 m-auto pt-20">
        ...
        @csrf
            ...
            <input type="text" name="title" placeholder="Titre..." class="bg-transparent block border-b-2 w-full h-20 text-6xl outline-none">
            ...
            <div class="bg-blue-lighter pt-15">
                <label class="w-44 flex flex-col items-center
                        px-2 py-3 bg-white-rounded-lg shadow-lg tracking-wide uppercase border border-blue cursor-pointer">
                   <span class="mt-2 text-base leading-normal px-3">Image</span>
